...
import 'package:bookia/feature/search/data/models/serch_response/data.dart';
import 'package:bookia/feature/search/data/models/serch_response/serch_response.dart';
import 'package:dartz/dartz.dart';

class SearchRemoteDataSourceImpl implements SearchRemoteDataSource {
  @override
  Future<Either<Failure, SerchResponse>> searchBooks(String query) async {
    ...
    return response.fold(
      (l) => Left(l),
      (right) => Right(
        SerchResponse(data: Data.fromJson(right as Map<String, dynamic>)),
      ),
    );
  }
}